...
def run_docker_container():
    ...
    cmd2 = [
        "python3", "vector_store_upload.py","--openai_key", openai_key ,"--port","6333"
    ]
...
def build_qa_chain():
    ...
    retriever = qdrant_vector_store.as_retriever(search_type="mmr", search_kwargs={"k": 4}) # Retrieve top 4 relevant documents
